...
<html lang="en" data-bs-theme="auto">
  ...
  <body>
        <%
            if (session.getAttribute("autoriza").equals("1")){
                //out.println("Autorizado: " + session.getAttribute("autoriza"));
            }else{
...
<main class="d-flex flex-nowrap">
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary" style="width: 280px;">
    <a href="#" class="d-flex align-items-center p-3 text-decoration-none">
        <img src="imagens/logo.png" width="70" height="70" id="logo">
        <span class="fs-4 ms-2">MyGameList</span>
    </a>
    <hr>
    <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item">
        <a href="meuperfil/meuperfil.html" target="main_page" class="nav-link active" aria-current="page">
      ...
      <li>
        <a href="desenvolvedora/desenvolvedora.html" target="main_page" class="nav-link link-body-emphasis">
          <i class="fas fa-code fa-icon"></i>
          Desenvolvedoras
        </a>
      </li>
      <li>
        <a href="plataformas/plataformas.html" target="main_page" class="nav-link link-body-emphasis">
